...
import { getStoreOAuthStatus } from '../../../lib/mercadopago/store-credentials.js';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        return res.status(statusCode).json({
            error: error?.message || 'No se pudo consultar el estado de Mercado Pago OAuth',
            code: error?.code || 'oauth_status_failed',
        });
    }
}
